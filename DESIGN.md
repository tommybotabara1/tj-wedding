...
- **Flight-path divider** — A centered dashed rule with a small plane/dove/ring glyph between sections; plus a fixed left-margin dashed rail (desktop) with a plane that tracks scroll progress.
